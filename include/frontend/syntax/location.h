...
/**
 ** \file "frontend/syntax/location.h"
 ** Define the  sed::frontend ::location class.
 */

#ifndef YY_YY_FRONTEND_SYNTAX_LOCATION_H__INCLUDED
# define YY_YY_FRONTEND_SYNTAX_LOCATION_H__INCLUDED
